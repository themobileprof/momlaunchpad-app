...
Premium-only capabilities (including live calls) are managed on the backend. The mobile app shows a **Coming soon** indicator in Settings until live calls are enabled for Premium members.
